...
public class testeCadastroClienteErro {
	...
	@Test
	public void testECadastroClienteErro() throws Exception {
		driver.get(baseUrl + "/DwGames/admin/clientelist.xhtml");
		driver.findElement(By.linkText("Cadastre-se")).click();
		driver.findElement(By.name("j_idt45:j_idt50")).clear();
		driver.findElement(By.name("j_idt45:j_idt50")).sendKeys("marcos");
		...
		driver.findElement(By.name("j_idt45:j_idt56")).sendKeys("marcos@mail");
		driver.findElement(By.name("j_idt45:j_idt59")).clear();
		driver.findElement(By.name("j_idt45:j_idt59")).sendKeys("marcos");
		driver.findElement(By.name("j_idt45:j_idt62")).clear();
		driver.findElement(By.name("j_idt45:j_idt62")).sendKeys("masculino");
		...
		assertEquals(
				"joao",
				driver.findElement(
						By.xpath("//form[@id='j_idt45']/table[2]/tbody/tr[15]/td[2]"))
						.getText());
		assertEquals(
				"marcos",
				driver.findElement(
